...
class _DashboardHomeFragmentState extends State<DashboardHomeFragment> {
  ...
  Color _getStatusColor(int status) {
    switch (status) {
      ...
      case 3: return Colors.orange; // 🔴 Orange for Late
        ...
        if (locations.isNotEmpty) {
          ...
          for (var emp in rawData) {
            ...
            if (att != null && att is Map && att.isNotEmpty) {
              ...
              sortTime = checkIn.isNotEmpty ? checkIn : (att['createdAt'] ?? "");
            }
              ...
              children: [
                ...
                loading
                  ...
                  children: [
                    ...
                    const SizedBox(width: 8),
                    _buildGlassStatCard("Late", late.toString(), Icons.access_time_filled, color: Colors.orangeAccent), // 🔴 Late Card
                    const SizedBox(width: 8),
                    _buildGlassStatCard("Half Day", halfDay.toString(), Icons.access_time_filled, color: Colors.purple), // 🔴 Late Card
                    const SizedBox(width: 8),
            ...
            child: ListView(
              ...
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const Text("Recently Present/Late", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E293B))),
                    GestureDetector(
...
// 🔴 TIME FORMATTER FIX
  ...
  Widget _buildEmployeeCard(Map<String, dynamic> emp) {
    ...
    String outTime = _formatTime(emp['checkOut']); // Agar empty hoga to --:-- ban jayega
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: Colors.blueGrey.withOpacity(0.08), blurRadius: 12, offset: const Offset(0, 4))
          ]
      ),
      child: Padding(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: statusColor.withOpacity(0.5), width: 2), // Status color border
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(2), // Gap between border and image
                    child: ClipOval(
                      child: fullImageUrl.isNotEmpty
                          ? Image.network(fullImageUrl, fit: BoxFit.cover, errorBuilder: (c, e, s) => Image.asset('assets/img.png'))
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(emp['designation'], style: TextStyle(fontSize: 10, color: Colors.grey.shade600, fontWeight: FontWeight.w600)),
                  ),
                  const SizedBox(height: 4),
                  Text(
                      statusText,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(inTime, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Colors.green)),
                    ],
                  ),
                  const SizedBox(height: 4),
                  // OUT TIME
                  Row(
                    children: [
                      ...
                      Text(outTime, style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: emp['checkOut'].isEmpty ? Colors.grey : Colors.redAccent)),
                    ],
                  ),
                ],
              ),
  ...
  Widget _buildGlassStatCard(String label, String value, IconData icon, {Color color = Colors.white}) {
    return Expanded( // Using Expanded to fit 4 cards
      child: Container(
